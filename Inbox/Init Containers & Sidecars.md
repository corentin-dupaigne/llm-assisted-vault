...
2. A **standard** init container blocks until it exits 0; the next then starts.
3. A **sidecar** only needs to *start* before the sequence continues, then stays running.
4. Once all are done/started, the app containers start.
